...
public class UserController {
	...
	public Model qrcode(Model model) {

		ByteArrayOutputStream out = QRCode.from("hello").to(ImageType.PNG).stream();
		String beseImg = Base64.encodeBase64String(out.toByteArray());
//		return beseImg;
		model.addAttribute("qr", beseImg);
//		model.setViewName("user/qrcode");
		return model;
